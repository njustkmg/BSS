...
if __name__ == '__main__':
    ...
    if True:
        ...
        for epoch in range(args.epochs):
            ...
            mean_loss_test1, test_acc1, test_map1 = test1(args, epoch, net, device, test_dataloader, optimizer, epoch_step_test)
            mean_loss_test2, test_acc2, test_map2 = test2(args, epoch, net, device, test_dataloader, optimizer, epoch_step_test)
            ...
            with open(results_file, 'a') as f:
                f.write(f'{epoch + 1} || {test_acc:.4f} {test_map:.4f} || {test_acc1:.4f} {test_map1:.4f} || {test_acc2:.4f} {test_map2:.4f}\n')
